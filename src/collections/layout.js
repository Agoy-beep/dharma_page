...
export const sourceTitleSubClassName = "text-4xl md:text-2xl my-4 md:ml-8 py-2 w-fit mx-auto text-center md:text-left normal-case bg-gray opacity-80 md:bg-transparent rounded-lg";
