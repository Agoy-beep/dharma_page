export const labels = [
  ...
  { 
    ...
    nl : 'Stel dat je aandacht vertrekt vanuit een punt in je hoofd. Dat is waar de ‘ik’ bestaat, de piloot achter de knoppen van je leven. Het centrum van je bestaan. Jij gebruikt je aandacht van daaruit als een zaklamp om iets in je omgeving te belichten. Je kijkt naar deze tekst bijvoorbeeld. Tegelijk ben je niet bezig met het gegeven of er al dan niet net een vogel een liedje aan het zingen is, tenzij die nu tegen je raam vliegt. Door het geluid van een vogel die tegen je raam vliegt, verplaatst je aandacht naar de oorsprong van het geluid. De vogel ligt roerloos op de grond en je begint je stilaan ongerust te voelen over zijn toestand. Gelukkig vindt de vogel terug zijn bewustzijn en kan hij opstijgen en verder gaan met zijn leven. Jij, immer empathisch dat je bent, voelt een golf van opluchting door je lichaam gaan. Wat een heftige rit. Herinner je de riviermetafoor. Het zou al handig zijn als je zou kunnen kijken naar de vloed van emoties die je soms kan ervaren, en niet door het water wordt meegesleurd.',
    en : 'A QUIET PLACE'
  },
  { 
